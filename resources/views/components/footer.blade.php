<footer class="bg-neutral-300 text-neutral-500">
    <section class="container mx-auto">
        <div class="hidden md:grid grid-cols-3 py-10">
            <div class="col-span-2">
                <div class="grid grid-cols-2">
                    <div>
                        <h2 class="text-xl text-black">Quick Links</h2>
                        <ul class="pt-10 leading-7">
                            <li><a href="/home" class="hover:text-white transition ease-in-out duration-300">Home</a>
                            </li>
                            <li><a href="/about-us" class="hover:text-white transition ease-in-out duration-300">About
                                    Us</a></li>
                            <li><a href="/blog" class="hover:text-white transition ease-in-out duration-300">Blog</a>
                            </li>
                            <li><a href="/contact"
                    ...
                    <div>
                        <h2 class="text-xl text-black">Address</h2>
                        <ul class="pt-10">
                            <li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="float-left w-6 h-6">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                                </svg>
                                <span class="ml-2">Jalan Street, Bali 80212</span>
                            </li>
                            <li class="ml-8">bbc@bvrgroupasia.com</li>
                            <li class="ml-8">+68xxxxxx</li>
                        </ul>
                        <ul class="pt-2">
                            <li><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" class="float-left w-6 h-6">
            ...
            <div class="mx-auto">
                <img src="../img/grey2.png" class="mt-12 h-20 w-20 mx-auto">
        ...
        <section class="md:py-6 container mx-auto">
            <div class="grid grid-cols-2 md:grid-cols-3 place-items-center md:hidden">
                <div class="text-md">
            ...
            <div class="block md:hidden place-items-center mx-auto">
                <img src="../img/grey2.png" class="mt-12 h-20 w-20 mx-auto">
                <div class="ml-3 mt-5 mb-6 flex justify-center">
                    <a href="javascript:void(0)"
                        class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                        <svg width="8" height="16" viewBox="0 0 8 16" class="fill-current">
                            <path
    ...
    <hr class="w-full h-0.5 bg-gray-100 rounded border-0 dark:bg-[#656464]">
    <section class="grid grid-cols-12 p-5 md:px-10 bg-neutral-300">
        <div class="col-span-12">
            <h5 class="flex items-center text-center md:text-left text-neutral-500 text-sm">Site Developed by <a
                    target="blank" href="https://bvrdigital.com"><img class="w-14 md:w-24 mx-5"
                        src="{{asset('/img/logo/digital-horizontal-blackfont.png')}}" alt="BVR Digital"></a>© 2022
                All
                Rights Reserved</h5>
        </div>
    </section>
            ...
            <div class="text-md">
                ...
                <div class="text-sm">
                    <ul>
                        ...
                        <li class="mt-1"><a class="hover:text-white transition ease-in-out duration-300"
                                href="/contact">Contact</a></li>
                        <li class="mt-1"><a class="hover:text-white transition ease-in-out duration-300" href="/#">Book
                                an Appointment</a></li>
                    </ul>
                </div>
            </div>
