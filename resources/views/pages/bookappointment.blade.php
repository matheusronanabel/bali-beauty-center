...
<main class="p-5 lg:p-20 container mx-auto font-light">
    <section class="grid grid-cols-4 gap-x-5 mx-auto">
        <!-- SELECT BOX -->
        <div class="col-span-2 justify-center">
            <h5 class="text-2xl py-3">DOCTOR</h5>
            <select
                class="form-select appearance-none block w-full h-16 px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding bg-no-repeat border border-solid border-[#DBCAB7] rounded transition ease-in-out focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none"
        ...
        <div class="">
            ...
            <button class="bg-[#BDA06A] appearance-none block w-full h-16 px-3 py-1.5 lg:text-xl text-white">CHECK
                AVAILABILITY</button>
        </div>
    </section>
    ...
    <section class="mt-32">
        ...
        <div class="mt-10 grid md:grid-cols-2 gap-10 mx-auto">
            <div>
                <h6>FIRST NAME</h6>
                <input class="border w-full h-16 border-[#BDA06A]" type="text" name="name" value="">
            </div>
            <div>
                <h6>LAST NAME</h6>
                <input class="border w-full h-16 border-[#BDA06A]" type="text" name="email" value="">
            </div>
            <div>
                <h6>PHONE</h6>
                <input class="border w-full h-16 border-[#BDA06A]" type="text" name="name" value="">
