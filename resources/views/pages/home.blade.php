...
<main class="p-5 md:p-0">
    ...
    <section class="mt-5">
        <div class="grid grid-cols-1 md:grid-cols-2 place-items-center text-4xl">
            <div>
                <h5 class="mt-5 md:mt-0 px-10">Female</h5>
            ...
            <div>
                <h5 class="mt-5 md:mt-0 px-10">Non-Surgical</h5>
                <img src="../img/grey2.png" class="w-screen">
            </div>
    </section>
    <!-- BANNER BALI BEAUTY CLINIC -->
    <section class="hidden mt-32 items-center bg-cover bg-full md:block" id="homeBackground"
    ...
    <section class="mt-32">
        <div class="grid md:grid-cols-2 gap-x-10 items-center">
            ...
            <div>
                ...
                <div class="md:mt-5 md:pr-32 leading-relaxed">
    ...
    <section class="mt-32 hidden md:block ">
        <div class="flex items-center justify-center">
            <div class="absolute text-xl text-center ml-1 mr-1 py-1 px-1 lg:ml-52 lg:mr-52 lg:py-32 lg:px-32 bg-white">
                <h1 class="text-2xl md:text-5xl lg:text-7xl uppercase">bring beauty to life</h1>
                <div class="px-5">
    ...
    <section class="mt-32 container mx-auto">
        <div class="grid md:grid-cols-2 gap-x-12">
            ...
            <div>
                <h1 class="text-3xl md:text-6xl uppercase font-semibold">bali beauty clinic founder</h1>
                <div class="block md:hidden">
    ...
    <section class="mt-32">
        ...
        <div class="mt-10 md:px-24 grid md:grid-cols-3 gap-x-10 text-center">
            <div>
