...
<header class="px-5 grid grid-rows-6 bg-center bg-cover"
    style="background-image: linear-gradient(to bottom, rgba(0, 0, 0, 0.3), rgba(0, 0, 0, 0.8)),url('./img/home/Header.png'); height: 100vh;">
    <div class="container mx-auto row-start-4">
        <h6 class="text-xl text-white">Welcome to</h6>
        <h1 class="py-5 font-bold text-white text-3xl md:text-6xl">ᬩᬮᬶᬩᬶᬬᬸᬢᬶᬓ᭄ᬮᬶᬦᬶ​ᬓ᭄᭟​</h1>
        <h6 class="text-md lg:text-xl text-white">
            <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 ml-3 mt-5 mb-6 items-center mx-auto">
                @yield('pageTitle')
                <div class="pl-[5%] grid grid-cols-4">
                    <a href="javascript:void(0)"
                        class="text-dark hover:bg-primary hover:border-primary mr-3 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] hover:text-white sm:mr-4 lg:mr-3 xl:mr-4">
                        <svg width="8" height="16" viewBox="0 0 8 16" class="fill-current">
                            <path
...
<main class="p-5 lg:p-0">
    ...
    <section class="pt-32">
        <div class="bg-cover bg-center grid grid-cols-12 grid-rows-6 place-items-center"
            style="background-image: url('./img/home/Frame.png'); height: 100vh;">
            <div class="col-start-2 col-span-10 md:col-start-3 md:col-span-8 row-start-2 row-span-4 bg-white">
                <div class="py-[5%] lg:py-[10%] px-[10%] text-justify grid grid-rows-4 gap-y-5 lg:gap-y-5">
                    <div class="place-self-center">
                        <h1 class="text-[5vw] md:text-[3.5vw] lg:text-[3vw] text-center">BRING BEAUTY TO LIFE</h1>
                    </div>
                    <div class="">
                        <p class="leading-relaxed text-[2.5vw] md:text-[1.7vw] lg:text-[1vw]">Lorem ipsum dolor sit
                            amet.
                            Eos
    ...
    <!-- <section class="mt-32">
        <div class="flex items-center">
            <div
                class="absolute text-justify px-12 bg-white">
                <h1 class="text-2xl text-[3vw] text-center uppercase">bring beauty to life</h1>
                <div class="px-5">
                    <p class="mt-1 leading-relaxed text-[0.8vw]">Lorem ipsum dolor sit amet. Eos
                        ipsa perspiciatis et cumque quibusdam
                        ex molestias consequatur ut
                        rerum cupiditate ut assumenda aliquam. Et galisum deleniti ab ducimus voluptas non vitae
                        iste.
...
<!-- BALI BEAUTY CLINIC BANNER SECTION 2 -->
<section class="mt-32 md:py-20 bg-no-repeat bg-cover" style="background-image: url('./img/home/IntroSection2.png');">
...
<main class="p-5 lg:p-0">
    <section class="mt-32">
        ...
        <div class="mt-10 lg:px-24 grid md:grid-cols-4 gap-y-10 md:gap-y-0 gap-x-5 lg:gap-x-10 text-center">
            <div class="grid md:grid-rows-4">
                <img src="../img/home/Dr-Park-Hye-Won.png" class="row-span-3 w-screen object-cover" alt="">
                <h2 class="mt-5 text-2xl lg:text-3xl">Dr. Park Hye Won</h2>
                <p class="">Lorem ipsum dolor sit amet.</p>
            </div>
            <div class="grid md:grid-rows-4">
                <img src="../img/home/Dr-Kwon-Soon-Hong.png" class="row-span-3 w-screen object-cover" alt="">
                <h2 class="mt-5 text-2xl lg:text-3xl">Dr. Kwon Soon Hong</h2>
                <p>Lorem ipsum dolor sit amet.</p>
            </div>
            <div class="grid md:grid-rows-4">
                <img src="../img/home/Dr-Kim-Mu-Hyun.png" class="row-span-3 w-screen object-cover" alt="">
                <h2 class="mt-5 text-2xl lg:text-3xl">Dr. Kim Mu Hyun</h2>
                <p>Lorem ipsum dolor sit amet.</p>
            </div>
            <div class="grid md:grid-rows-4">
                <img src="../img/home/Dr-Joo-Kwon.png" class="row-span-3 w-screen object-cover" alt="">
                <h2 class="mt-5 text-2xl lg:text-3xl">Dr. Joo Kwon</h2>
                <p>Lorem ipsum dolor sit amet.</p>
            </div>
        </div>
    </section>
